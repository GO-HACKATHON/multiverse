...
public class BatchCommitterBolt extends RubyObject implements ICommitter, IBatchBolt {
    ...
    static {
        String source = new StringBuilder("require 'java'\n" +
            ...
            "end\n" +
            "").toString();
        __ruby__.executeScript(source, "/root/.rbenv/versions/jruby-1.7.4/lib/ruby/gems/shared/gems/redstorm-0.6.6/lib/red_storm/proxy/batch_committer_bolt.rb");
        RubyClass metaclass = __ruby__.getClass("BatchCommitterBolt");
        metaclass.setRubyStaticAllocator(BatchCommitterBolt.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: BatchCommitterBolt");
     ...
     */
    private BatchCommitterBolt(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new BatchCommitterBolt(ruby, metaClass);
    }

    
    public  BatchCommitterBolt(String base_class_path, String real_bolt_class_name) {
