...
public class Bolt extends RubyObject implements IRichBolt {
    ...
    static {
        String source = new StringBuilder("require 'java'\n" +
            ...
            "end\n" +
            "").toString();
        __ruby__.executeScript(source, "/root/.rbenv/versions/jruby-1.7.4/lib/ruby/gems/shared/gems/redstorm-0.6.6/lib/red_storm/proxy/bolt.rb");
    ...
    public void prepare(Map conf, TopologyContext context, OutputCollector collector) {
        ...
        IRubyObject ruby_result = Helpers.invoke(__ruby__.getCurrentContext(), this, "prepare", ruby_conf, ruby_context, ruby_collector);
        return;
