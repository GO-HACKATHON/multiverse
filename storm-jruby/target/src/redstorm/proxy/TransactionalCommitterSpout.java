...
public class TransactionalCommitterSpout extends RubyObject implements ICommitterTransactionalSpout {
    ...
    static {
        String source = new StringBuilder("require 'java'\n" +
            ...
            "\n" +
            "end").toString();
        __ruby__.executeScript(source, "/root/.rbenv/versions/jruby-1.7.4/lib/ruby/gems/shared/gems/redstorm-0.6.6/lib/red_storm/proxy/transactional_committer_spout.rb");
